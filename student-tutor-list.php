...
$sql = "SELECT * FROM tutors WHERE assigned_student_id = $id LIMIT $start_from, $results_per_page";
$result = mysqli_query($con, $sql);
$tutors = [];
        ...
        <tbody>
            ...
            foreach ($tutors as $tutor):
                ...
                <tr>
                    ...
                    <td class="student-name-column"><?php echo $tutor['name']; ?></td>
                    <td class="student-age-column"><?php echo $tutor['age']; ?></td>
                    <td class="student-email-column"><?php echo $tutor['email']; ?></td>
                </tr>
                <?php
